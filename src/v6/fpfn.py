...
class FPFN(Detector):
    ...
    def get_inconsistency_indices(self):
        ...
        self.incon_indices = mismatching ##mayuresh: to test impact of removing the final classifier
    ...
    def cross_validation(self, classifier, features, labels, nfolds):
        ...
        kf = StratifiedKFold(nfolds, shuffle=True, random_state = 0) ##mayuresh: Stratified should improve the results
